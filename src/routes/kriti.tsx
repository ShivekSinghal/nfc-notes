...
const teacher = getTeacher("kriti");

export const Route = createFileRoute("/kriti")({
  head: () => ({
    meta: [
      { title: "For Kriti — a thank-you from Shivek" },
      { name: "description", content: "A small thank-you, delivered by tap." },
      { property: "og:title", content: "For Kriti — a thank-you from Shivek" },
