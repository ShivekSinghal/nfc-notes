...
const teacher = getTeacher("jhilmil");

export const Route = createFileRoute("/jhilmil")({
  head: () => ({
    meta: [
      { title: "For Jhilmil — a thank-you from Shivek" },
      { name: "description", content: "A small thank-you, delivered by tap." },
      { property: "og:title", content: "For Jhilmil — a thank-you from Shivek" },
